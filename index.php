        ...
        <ul class="nav-menu">
            <li class="nav-menu__element">
                <a class="nav-menu__link nav-menu__link--active" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-home">
            ...
            <li class="nav-menu__element">
                <a class="nav-menu__link" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-graduation-cap"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
    ...
    <footer class="footer">
        ...
        <ul class="footer-reso">
            <li class="footer-reso__element">
                <a class="footer-reso__link" href=""><i class="fa-brands fa-linkedin"></i></a>
            </li>
            <li class="footer-reso__element">
                <a class="footer-reso__link" href=""><i class="fa-brands fa-instagram"></i></a>
            </li>
        </ul>
    </footer>
</body>
